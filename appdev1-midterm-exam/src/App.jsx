    ...
    <>
      ...
      <section id="services" className="services section">
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-3 col-md-6"><div className="service-item"><img src=" /images/service-icon-01.png" alt="" /><h4>App Maintenance</h4></div></div>
            <div className="col-lg-3 col-md-6"><div className="service-item"><img src=" /images/service-icon-02.png" alt="" /><h4>Rocket Speed</h4></div></div>
            <div className="col-lg-3 col-md-6"><div className="service-item"><img src=" /images/service-icon-03.png" alt="" /><h4>Best Security</h4></div></div>
            <div className="col-lg-3 col-md-6"><div className="service-item"><img src=" /images/service-icon-04.png" alt="" /><h4>24/7 Support</h4></div></div>
          </div>
        </div>
      </section>
      ...
      <section id="about" className="about section">
        <div className="container">
          <div className="row">
            <div className="col-lg-6"><img src=" /images/about-left-image.png" alt="About" /></div>
            <div className="col-lg-6 align-self-center">
